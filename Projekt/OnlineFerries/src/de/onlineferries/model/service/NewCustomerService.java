...
public interface NewCustomerService {
	...
	boolean updateCustomer(String password, String firstname, String name, String city, String street, String zipcode, String email, Integer bank_id, Integer account_nr);
}
