...
public class ReservationHandler implements Serializable {
	...
	public void setTripHandler(TripHandler tripHandler) { this.tripHandler = tripHandler; }
	...
	public String saveReservation() {
		...
		ReservationView reservationView = new ReservationView(
			tripHandler.getTrip(), loginHandler.getCustomer(), shipCabins, cars, travellerNames);
	...
	public void changeTraveller(ValueChangeEvent ev) {		
		...
		for (int i = 0; i < travellers; i++) travellerNames.add(new TravellerView(i, ""));
